        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JenisKelamin = table.Column<bool>(nullable: false),
                    Nama = table.Column<string>(nullable: true),
                    NoTelepon = table.Column<string>(nullable: true),
                    Pekerjaan = table.Column<string>(nullable: true),
                    StatusNikah = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TheAlamat = table.Column<string>(nullable: true),
                    UpdatedBy = table.Column<string>(nullable: true),
                    UpdatedDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Alamat_Customer_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandAndCategory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BrandAndCategory_Brand_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brand",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BrandAndCategory_Category_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingCount = table.Column<long>(nullable: false),
                    UpdatedBy = table.Column<string>(nullable: true),
                    UpdatedDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductInstance_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<long>(nullable: false),
                    ProductId = table.Column<long>(nullable: false),
                    TanggalReview = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ProductInstanceOptions",
                columns: table => new
                {
                    ProductInstanceId = table.Column<long>(nullable: false),
                    OptionValueId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInstanceOptions", x => new { x.ProductInstanceId, x.OptionValueId });
                    table.ForeignKey(
                        name: "FK_ProductInstanceOptions_OptionValue_OptionValueId",
                        column: x => x.OptionValueId,
                        principalTable: "OptionValue",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductInstanceOptions_ProductInstance_ProductInstanceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandAndCategory_CategoryId",
                table: "BrandAndCategory",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInstanceOptions_OptionValueId",
                table: "ProductInstanceOptions",
